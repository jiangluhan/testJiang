...
//    }
    ...
    public static void main(String[] args) {
        ...
        String qrString = spawnScanQRString("jiangluhan-test", secretKey, "test");
        System.out.println(qrString);
        String code = "165828";
        String rightGoogleCode = GoogleAuthenticationTool.getTOTPCode("2Y2PDEV35CHQCJTZITQRZOJEYZD2Z47W");
        if(rightGoogleCode.equals(code)) {
